...
VALUES
  ...
  (
    ...
    '13950',
    '085785001500',
    'ferryhandoko10@yahoo.com'
  ),
  (
    6,
    'Bagus Wijaya Mahendra',
    '1144520',
    'Bandung',
    '17 Agustus 1996',
    'Laki-laki',
...
VALUES
  (
    1,
    'SMPN 172 Pulogebang',
    'Jl. St. Cakung No.2, RT.10/RW.3, Pulo Gebang, Kec. Cakung, Kota Jakarta Timur, Daerah Khusus Ibukota Jakarta 13950',
    '9.0'
  );
-- --------------------------------------------------------
  --
...
ALTER TABLE `smp`
ADD
  CONSTRAINT `smp_ibfk_1` FOREIGN KEY (`id`) REFERENCES `ppdb` (`id`);
COMMIT;
