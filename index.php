        ...
        <div class="container">
            ...
            <nav class="main-nav float-right d-none d-lg-block">
                <ul>
                    ...
                    <li><a target="blank" href="daftar.php">DAFTAR</a></li>
                </ul>
            </nav><!-- .main-nav -->
    ...
    <section id="intro" class="clearfix">
        <div class="container">
            ...
            <div class="intro-info">
                <h2>Selamat datang di website <span>PPDB</span><br>SMA ABC 20 Jakarta</h2>
                <div>
                    <a href="#tentang" class="btn-get-started scrollto">Tentang Kami</a>
                    <a target="blank" href="daftar.php" class="btn-services scrollto">Daftar</a>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-contact">
                        <h4>Kontak Kami</h4>
                        <p>
                            Jl. Sudirman 42, Jakarta Pusat, 14440<br>
