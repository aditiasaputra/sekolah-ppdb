              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <p class="mb-4">Kami mengerti, banyak hal terjadi begitu saja. Dengan Anda memasukkan alamat email di bawah ini, maka Kami akan mengirimkan tautan untuk mereset kata sandi Anda!</p>
                  </div>
                  <form class="user">
